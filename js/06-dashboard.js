...
function barberForm(id){
  ...
  <div class="modal-body">
    ...
    <div class="field"><label>URL da foto</label><input class="input" id="ba_photo" value="${b?escapeHtml(b.photoUrl||''):''}" placeholder="https://.../foto-do-barbeiro.jpg"><small class="muted">Aparece para o cliente na página pública e na escolha do profissional.</small></div>
...
function dashConfig(shop){
  ...
  <div class="panel"><div class="panel-head"><h3>Informações</h3><a class="btn btn-ghost btn-sm" onclick="Router.go('#/'+'${shop.slug}')">${icon('eye')} Ver página pública</a></div>
    ...
    <div class="field"><label>URL do logo</label><input class="input" id="cf_logo" value="${escapeHtml(shop.logoUrl||'')}" placeholder="https://.../logo-da-barbearia.png"><small class="muted">Esse logo aparece no painel da barbearia, login contextual e link público do cliente.</small></div>
